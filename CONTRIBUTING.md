## 🛠️ Contributing to zkRamp 🛠️

Welcome, contributing to `zkRamp` is easy!

1. Submit or comment your intent on an issue
2. We will try to respond quickly
3. Fork this repo
4. Submit your PR against `develop`
5. Address PR Review

Use the ![telegram group](https://t.me/+hlNRN4PmGrExYTY8) if you wish to discuss an issue in a less formal way.

### Issue

Project tracking is done via GitHub [issues](https://github.com/keep-starknet-strange/zkramp/issues).
...
and voilà you're a `zkRamp` contributor.
